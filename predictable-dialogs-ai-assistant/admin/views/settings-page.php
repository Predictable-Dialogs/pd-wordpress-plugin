  ...
  <form method="post" action="options.php" class="pd-settings-form">
    ...
    <table class="form-table" role="presentation">
      <tbody>
        <tr>
          <th scope="row">
            <label for="pd-snippet"><?php esc_html_e('Initialization snippet', 'predictable-dialogs-ai-assistant'); ?></label>
          </th>
          <td>
            <textarea
              id="pd-snippet"
        ...
        <tr>
          <th scope="row">
            <label for="pd-excluded-pages"><?php esc_html_e('Excluded pages', 'predictable-dialogs-ai-assistant'); ?></label>
          </th>
          <td>
            <input
              type="text"
        ...
        <tr>
          <th scope="row">
            <label for="pd-include-user"><?php esc_html_e('Inject logged-in WordPress user', 'predictable-dialogs-ai-assistant'); ?></label>
          </th>
          <td>
            <label>
              <input
              ...
              />
              <?php esc_html_e('Pass logged-in user data to the widget as PD.user', 'predictable-dialogs-ai-assistant'); ?>
            </label>
            <p class="description">
        ...
        <tr>
          <th scope="row">
            <label for="pd-disable-widget"><?php esc_html_e('Disable widget', 'predictable-dialogs-ai-assistant'); ?></label>
          </th>
          <td>
    ...
    <?php submit_button(__('Save Settings', 'predictable-dialogs-ai-assistant'), 'primary', 'pd-save-settings', true, 'id="pd-save-settings"'); ?>
  </form>
</div>
<script>
  (function () {
